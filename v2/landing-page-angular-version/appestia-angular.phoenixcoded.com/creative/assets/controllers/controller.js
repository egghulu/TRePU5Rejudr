...
app.controller('MyController', function ($scope,$document, $anchorScroll,$window, $timeout,$compile) {
   ...
   /*Color picker Start*/
	...
	angular.element('.color-6').bind('click', function() {
	    ...
	    angular.element('#color').attr("href", "assets/css/color/color-6.css" );
	    return false;
	});
	angular.element('.color-7').bind('click', function() {
		
	    angular.element('#color').attr("href", "assets/css/color/color-7.css" );
	    return false;
	});
	angular.element('.color-8').bind('click', function() {

	    angular.element('#color').attr("href", "assets/css/color/color-8.css" );
	    return false;
	});
