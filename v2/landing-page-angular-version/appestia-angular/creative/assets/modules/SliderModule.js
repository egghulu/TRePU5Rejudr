...
var app=angular.module('creativeSlider', ['ngAnimate','angularRipple','uiGmapgoogle-maps','angular.backtop','duScroll','angular-scroll-animate','ng-backstretch','ui.bootstrap','angular-parallax']);
...
app.directive('sliderBanner', function ($window) {  
