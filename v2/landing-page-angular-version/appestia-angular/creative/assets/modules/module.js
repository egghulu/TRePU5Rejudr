...
var app=angular.module('creative', ['ngAnimate','angularRipple','uiGmapgoogle-maps','angular.backtop','duScroll','angular-scroll-animate','ui.bootstrap','angular-parallax']);
  ...
  return {
    link: function () {
     ...
     if (m.innerWidth() >= 1600) {
      ...
      angular.element('#index-banner').css('min-height', windowHeight);
    }
    
    else{
      
     angular.element('#header').removeClass('home-center');
   }
 }       
};  
});  
